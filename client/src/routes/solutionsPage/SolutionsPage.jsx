...
const SolutionsPage = () => {
  return (
    <main className="flex-1 flex flex-col items-center justify-center p-4 sm:p-10 text-center animate-fade-in-up">
      <h1 className="text-3xl sm:text-5xl font-serif font-medium mb-4">Solutions</h1>
      <p className="text-xl text-text-secondary max-w-2xl">
        Tailored solutions for students, educators, and institutions.
      </p>
      
      <div className="flex flex-col gap-10 sm:gap-20 mt-10 sm:mt-16 max-w-7xl w-full">
         
         {/* For Students */}
         <div className="bg-white p-6 sm:p-12 rounded-2xl sm:rounded-[2.5rem] border border-gray-100 shadow-xl shadow-indigo-100/50 flex flex-col md:flex-row gap-6 sm:gap-12 items-center text-left">
            <div className="flex-1">
               <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-text-primary">For Students</h2>
            ...
            <div className="flex-1 h-52 sm:h-80 w-full rounded-2xl sm:rounded-3xl overflow-hidden">
                <img src="/solutions_students.jpg" alt="Students collaborating" className="w-full h-full object-cover" />
            </div>
         </div>
         
         {/* For Educators */}
         <div className="bg-indigo-600 text-white p-6 sm:p-12 rounded-2xl sm:rounded-[2.5rem] shadow-2xl shadow-indigo-500/30 flex flex-col md:flex-row-reverse gap-6 sm:gap-12 items-center text-left">
            <div className="flex-1">
               <h2 className="text-2xl sm:text-3xl font-bold mb-4">For Educators</h2>
            ...
            <div className="flex-1 h-52 sm:h-80 w-full rounded-2xl sm:rounded-3xl overflow-hidden border border-white/20">
                <img src="/solutions_educators.jpg" alt="Educator in classroom" className="w-full h-full object-cover" />
            </div>
         </div>

         {/* For Institutions */}
         <div className="bg-surface-secondary p-6 sm:p-12 rounded-2xl sm:rounded-[2.5rem] border border-gray-100 flex flex-col md:flex-row gap-6 sm:gap-12 items-center text-left">
            <div className="flex-1">
               <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-text-primary">For Institutions</h2>
               <p className="text-lg text-text-secondary mb-8 leading-relaxed">
