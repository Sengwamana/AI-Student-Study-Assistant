...
const ProductPage = () => {
  return (
    <main className="flex-1 flex flex-col items-center justify-center p-4 sm:p-10 text-center animate-fade-in-up">
      <h1 className="text-3xl sm:text-5xl font-serif font-medium mb-4">Product</h1>
      ...
      <div className="flex flex-col gap-12 sm:gap-24 mt-10 sm:mt-16 max-w-7xl w-full">
         {/* AI Tutor Section */}
         <div className="flex flex-col md:flex-row gap-6 sm:gap-12 items-center text-left">
            <div className="flex-1">
               ...
               <h2 className="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6 text-text-primary">Your Personal AI Tutor</h2>
            ...
            <div className="flex-1 h-[250px] sm:h-[400px] w-full rounded-2xl sm:rounded-3xl overflow-hidden border border-gray-200 shadow-xl shadow-gray-200/50">
               <img src="/product_ai_tutor.jpg" alt="AI Tutor Interface" className="w-full h-full object-cover" />
            </div>
         </div>

         {/* Study Plans Section */}
         <div className="flex flex-col md:flex-row-reverse gap-6 sm:gap-12 items-center text-left">
            <div className="flex-1">
               ...
               <h2 className="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6 text-text-primary">Adaptive Study Schedules</h2>
               <p className="text-lg text-text-secondary mb-6 leading-relaxed">
         ...
         <div className="flex flex-col md:flex-row gap-6 sm:gap-12 items-center text-left">
            <div className="flex-1">
               ...
               <h2 className="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6 text-text-primary">Auto-Generated Quizzes</h2>
               <p className="text-lg text-text-secondary mb-6 leading-relaxed">
