  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white relative overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-start lg:justify-center px-4 sm:px-8 md:px-12 py-6 sm:py-8 lg:py-12 relative overflow-y-auto">
        ...
        <div className="absolute -top-[20%] -right-[10%] w-[300px] sm:w-[400px] h-[300px] sm:h-[400px] bg-[radial-gradient(circle,rgba(249,115,22,0.08)_0%,transparent_70%)] rounded-full pointer-events-none animate-float-orb lg:hidden"></div>
        <div className="absolute -bottom-[15%] -left-[10%] w-[250px] sm:w-[350px] h-[250px] sm:h-[350px] bg-[radial-gradient(circle,rgba(168,85,247,0.06)_0%,transparent_70%)] rounded-full pointer-events-none animate-float-orb-reverse lg:hidden"></div>
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="mb-5 sm:mb-8 text-center lg:text-left">
            ...
            <p className="text-sm sm:text-base text-gray-500">Get started for free — no credit card required</p>
          </div>
